...
[AP]  According to an Indonesian study, coastal areas in the country have suffered significantly due to the pandemic \citep{teniwut2021covid}. Towards the beginning of 2020, although Indonesia's number of Covid cases was relatively low, the impact on the local economy was palpable due to the decrease in overseas demand for local aquaculture and farming products and limited shipping access.  According to the author, even the ``perception of declining fishery conditions’’ was found to aggravate social problems like inter-village conflicts (p. 186). But the number of Covid cases in the country started to increase steadily around November 2020 and the government response peaked in December of that year. 
...
One identification strategy to examine the effects of economic hardshipson piracy events is to compare the the number of events before and after a country implements a harsh stringency measure. 



Does poverty substantively affect piracy? Understanding the causal effects of poverty is difficult since the variable is intertwined with so many other variables such as governance, its geographical dispersion, population and other demographic factors. In such scenario, events that spur economic crises and poverty provide an opportunity to examine its impact in an experiment-like scenario. Comparison of immediate pre- and post-crises of a single case helps us understand the effect of crisis-induced poverty on certain outcomes like crime, or, in our case, piracy. For identification, the immediate pre- or post- effect is preferable than data spanning longer time frame since the effect of other factors tend to dilute the result as we increase the time span. 


In this study, we look at two piracy-prone country cases, Indonesia and Nigeria. The two countries are the two highest piracy prone countries but in different regions of the world. 
...
```{r, figures-side, fig.show="hold", out.width="48%", echo = FALSE, message=FALSE, fig.cap='Count of piracy events', fig.cap.align='center',}
par(mar = c(4, 4, .1, .1))
...
We now examine the effect of covid on piracy using monthly cases of Covid and piracy in the two countries, Indonesia and Nigeria where COVID-19 cases peaked at different periods. Rather than just the actual pandemic, we expect government-imposed restrictions to curb the pandemic will have a more severe effect on the local economy and individual poverty level. This pandemic-induced poverty, in turn, should affect monthly piracy incidents. To test our hypotheses, we use interrupted time series analysis, which tracks the trend over time, before and after an intervention, which in our case is the stringent measures from \citet{hale2021global}. We modify the daily stringency measures from the dataset into monthly cumulative measure by aggregating the following government responses each month: school closures, workplace closures, canceled public events, gathering restrictions, public transport closures, stay at home orders, internal movement restrictions, and international travel controls. Each of these responses is coded as 1 if the government declared restriction on that criteria and 0 otherwise. For instance, if a country imposed all eight types of restrictions every day for a month, the cumulative restriction for the month is calculated as 8x30=240. We consider months following the highest level cumulative restriction as the post-intervention period. 
 ...
 There was a substantive variation on how countries imposed these stringency measures. While many factors may have led the governments to impose restrictions, the main driving factor was the reported Covid cases in the country. The figure below shows the 30-day cumulative stringency measures based on the 8 factors. As shown in the figure, Nigeria and some other countries in the Gulf of Guinea imposed heavier restrictions early on, whereas countries in Southeast Asia were less affected early on. Indonesia saw the surge in covid cases only in the second wave of the Delta variant. As a result, Nigeria has the intervention in April 2020 while Indonesia has intervention much later, in December 2020. 




```{r, figures-side-2, fig.show="hold", out.width="50%", echo = FALSE, message=FALSE, fig.cap='Stringency measures', fig.cap.align='center', fig.align="center"}

knitr::include_graphics("figures/cumulative_restriction_indo_nigeria.pdf")
```
<!-- \textit{Note: Figure above shows monthly cumulative restriction in the two countries.} -->


## Empirics


Table 1 shows the results of interrupted time series analysis where the covid-induced stringency in Indonesia and Nigeria is compared against control-case countries Japan and Taiwna in Southeast Asia and Ghana and Liberia in the Gulf of Guinea. 
