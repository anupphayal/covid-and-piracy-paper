...
title: The Unexpected Consequences of a Public Health Emergency
author: 
rights:  Creative Commons Attribution 4.0 International
language: en-US
tags: Covid-19, maritime piracy
abstract: |
...
## The Link Between COVID-19 and Maritime Piracy
...
Does poverty substantively affect piracy? Understanding the causal effects of poverty is difficult since the variable is intertwined with so many other variables such as governance, its geographical dispersion, population and other demographic factors. In such scenario, events that spur economic crises and poverty provide an opportunity to examine its impact in an experiment-like scenario. Comparison of immediate pre- and post-crises of a single case helps us understand the effect of crisis-induced poverty on certain outcomes like crime, or, in our case, piracy. In this study, we look at two piracy-prone country cases, Indonesia and Nigeria. 
...
```{r, figures-side, fig.show="hold", out.width="50%", echo = FALSE, message=FALSE, fig.cap='Some cool caption', fig.cap.align='center',}
par(mar = c(4, 4, .1, .1))
knitr::include_graphics("figures/yearly_piracy_1993-2021.pdf")
knitr::include_graphics("figures/yearly_piracy_loess_1993-2021.pdf")
```
						...
						\hline
							...
							Observation         &      54   &      54   \\
								\hline
												\end{tabular}
 	\begin{tablenotes}
	\item Note: The table above shows the effect of covid stringency onpiracy controlling for nearby countries which had far less stringency compared to the country cases around the same time frame.
\end{tablenotes}
